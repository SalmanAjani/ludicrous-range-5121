    ...
    function use(){
      ...
      li1.innerText="Gently buff bronzer onto cheekbones, chin, nose and forehead"
      let li2= document.createElement("li");
      li2.innerText="Sweep blush on the apple of your cheeks for an endless glow"
      let li3= document.createElement("li");
      li3.innerText="Apply highlighter to high points of the face, including cheekbones, nose, inner corners of eyes and cupid’s bow"
      ul1.append(li1,li2,li3)
      let most= document.createElement("p")
      most.innerHTML="<b>Matte Eyeshadow Shades: </b>"
      let text1= document.createElement("p")
      text1.innerText="- Apply with fluffy, dome-shaped eyeshadow brushes to effortlessly blend colours into your crease to contour your eyes. Use a dense brush for added depth and definition"
    ...
    function ques(){
      ...
      a1.innerHTML="<b>A.</b>" +"<span>The Contour De Force Eyes And Face Palette 01 - Warm Win has a cool brown matte bronzer and a light peach matte blush. On the other hand, the 02 - Pink Pro comes with a deep tan matte bronzer and a salmon pink blush with a subtle shimmer.</span>"
      ...
      a2.innerHTML="<b>A.</b>"+"<span>Both the variants of the new palette work brilliant for all skin tones. The versatile mix of nude and bold shades will definitely take your makeup to the next level. 01 - Warm Win works well for light-to-medium skin tones while 02 - Pink Pro for medium-to-deep skin tones.</span>"
      ...
      a3.innerHTML="<b>A.</b>"+"<span> Yes. You get 2 mini brushes. One to play with the highly pigmented eyeshadow colours and the other to apply blush and bronzer. This travel-friendly makeup palette also has a in-built mirror for makeup application on-the-go!</span>"
